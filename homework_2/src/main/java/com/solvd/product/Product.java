...
public class Product implements Comparable<Product> {
    ...
    public boolean equals(Object o) {
        ...
        if(!Objects.equals(this.name, product.name)) return false;
        if(!Objects.equals(this.barcode, product.barcode)) return false;
        if(!Objects.equals(this.description, product.description)) return false;
